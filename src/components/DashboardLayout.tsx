import React from 'react';
    ...
    import { FileText, LogOut, Users, Settings, Menu } from 'lucide-react';
          ...
          <div className={`lg:ml-64 min-h-screen transition-all duration-200 ${isSidebarOpen ? 'ml-64' : 'ml-0'}`}>
            <main className="p-6">
              ...
              <button
                ...
                className="fixed bottom-4 right-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                New Template
              </button>
            </main>
